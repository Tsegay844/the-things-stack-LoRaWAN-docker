/**
  ******************************************************************************
  * @file    stm32wlxx_olimex.h
  * @author  MCD Application Team
  * @brief   Header for stm32wlxx_olimex.c
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32WLXX_OLIMEX_H
#define STM32WLXX_OLIMEX_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32wlxx_olimex_errno.h"
#include "stm32wlxx_olimex_conf.h"
...
/** @defgroup STM32WLXX_OLIMEX STM32WLXX-OLIMEX
  * @{
  */

/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL LOW LEVEL
  * @{
  */

/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
typedef enum 
{
...
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_Exported_Constants LOW LEVEL Exported Constants
  * @{
  */ 

/**
  * @brief STM32WLXX OLIMEX BSP Driver version number
  */
#define __STM32WLXX_OLIMEX_BSP_VERSION_MAIN   (0x01U) /*!< [31:24] main version */
#define __STM32WLXX_OLIMEX_BSP_VERSION_SUB1   (0x01U) /*!< [23:16] sub1 version */
#define __STM32WLXX_OLIMEX_BSP_VERSION_SUB2   (0x00U) /*!< [15:8]  sub2 version */
#define __STM32WLXX_OLIMEX_BSP_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define __STM32WLXX_OLIMEX_BSP_VERSION        ((__STM32WLXX_OLIMEX_BSP_VERSION_MAIN << 24)\
                                              |(__STM32WLXX_OLIMEX_BSP_VERSION_SUB1 << 16)\
                                              |(__STM32WLXX_OLIMEX_BSP_VERSION_SUB2 << 8 )\
                                              |(__STM32WLXX_OLIMEX_BSP_VERSION_RC))

/** 
  * @brief Define for STM32WLXX_OLIMEX board
  */ 
#if !defined (USE_STM32WLXX_OLIMEX)
 #define USE_STM32WLXX_OLIMEX
#endif

/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_LED LOW LEVEL LED Constants
  * @{
  */
#define LEDn                                    3
...
*/
#define LEDx_GPIO_CLK_ENABLE(__INDEX__)         __HAL_RCC_GPIOA_CLK_ENABLE() /* All Led on same port */
#define LEDx_GPIO_CLK_DISABLE(__INDEX__)        __HAL_RCC_GPIOA_CLK_DISABLE() /* All Led on same port */
/**
  * @}
  */ 
  
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_BUTTON LOW LEVEL BUTTON Constants
  * @{
  */  
#define BUTTONn                                 3
...
#if (USE_BSP_COM_FEATURE > 0)
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_COM LOW LEVEL COM Port Constants
  * @{
  */  
...
/** @addtogroup STM32WLXX_OLIMEX_LOW_LEVEL_Exported_Variables
  * @{
  */
...
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_Exported_Functions LOW LEVEL Exported Functions
  * @{
  */
uint32_t         BSP_GetVersion(void);

/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_LED_Functions LOW LEVEL LED Functions
  * @{
  */
...
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_BUTTON_Functions  LOW LEVEL BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE > 0)
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_COM_Functions LOW LEVEL COM Port Functions
  * @{
  */  
