/**
  ******************************************************************************
  * @file    stm32wlxx_olimex.c
  * @author  MCD Application Team
  * @brief   This file provides set of firmware functions to manage:
  *          - LEDs and push-buttons available on STM32WLXX-OLIMEX
...
/** @addtogroup STM32WLXX_OLIMEX
  * @{
  */

/** @addtogroup STM32WLXX_OLIMEX_LOW_LEVEL
  * @brief This file provides set of firmware functions to manage LEDs and push-buttons
  *        on STM32WLXX-OLIMEX Kit from STMicroelectronics.
  * @{
  */


/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Variables
  * @{
  */
...
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_Private_Defines LOW LEVEL Private Defines
  * @{
  */
/**
  * @}
...
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_Private_TypesDefinitions LOW LEVEL Private Typedef
  * @{
  */
...
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_Private_Variables LOW LEVEL Private Variables
  * @{
  */
...
/** @defgroup STM32WLXX_OLIMEX_LOW_LEVEL_Private_Functions LOW LEVEL Private Functions
  * @{
  */
...
/** @addtogroup STM32WLXX_OLIMEX_LOW_LEVEL_Exported_Functions
  * @{
  */ 

/**
  * @brief  This method returns the STM32WLXX OLIMEX BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
uint32_t BSP_GetVersion(void)
{
  return (int32_t)__STM32WLXX_OLIMEX_BSP_VERSION;
}

/** @addtogroup STM32WLXX_OLIMEX_LOW_LEVEL_LED_Functions
  * @{
  */ 
...
/** @addtogroup STM32WLXX_OLIMEX_LOW_LEVEL_BUTTON_Functions
  * @{
  */ 
...
#if (USE_BSP_COM_FEATURE > 0)
/** @addtogroup STM32WLXX_OLIMEX_LOW_LEVEL_COM_Functions
  * @{
  */
/**
...
/** @addtogroup STM32WLXX_OLIMEX_LOW_LEVEL_Private_Functions
  * @{
  */
