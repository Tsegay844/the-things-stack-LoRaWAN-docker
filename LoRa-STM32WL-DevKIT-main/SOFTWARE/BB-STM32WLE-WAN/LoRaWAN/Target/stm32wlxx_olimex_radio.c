/**
  ******************************************************************************
  * @file    stm32wlxx_OLIMEX_radio.c
  * @author  MCD Application Team
  * @brief   This file provides set of firmware functions to manage:
  *          - RF circuitry available on STM32WLXX-OLIMEX
...
/** @addtogroup STM32WLXX_OLIMEX_RADIO_LOW_LEVEL
  * @brief This file provides set of firmware functions to Radio switch 
  *        available on STM32WLXX-OLIMEX Kit from STMicroelectronics.
  * @{
  */

/** @addtogroup STM32WLXX_OLIMEX_RADIO_LOW_LEVEL_Exported_Functions
  * @{
  */
